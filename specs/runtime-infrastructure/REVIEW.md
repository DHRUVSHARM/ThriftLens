...
- `python3 -m py_compile backend/app/config.py backend/app/db.py backend/app/storage.py backend/app/redis_client.py backend/app/health.py backend/app/main.py backend/app/worker.py`
